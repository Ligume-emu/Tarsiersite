  ...
  <footer id="contact" className="bg-[#141210] pt-0 pb-10 relative overflow-hidden">
    ...
    <div className="max-w-[1280px] mx-auto px-6 text-center relative z-10">
      ...
      <div className="flex justify-center gap-4 mb-12">
        {socials.map((s) => (
          <a key={s.label} href="#" aria-label={s.label} className="w-10 h-10 flex items-center justify-center rounded-full text-tarsier-light hover:text-primary-foreground transition-colors">
