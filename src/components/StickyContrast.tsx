...
const StickyContrast = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-12 top-1/2 -translate-y-1/2 z-10" style={{ width: '320px' }}>
        {/* Statement cycling */}
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div>
                ...
                <p className="font-display text-[18px] lg:text-[22px] font-semibold text-neutral-900 leading-tight">
