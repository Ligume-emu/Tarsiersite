...
const FAQSection = () => {
  ...
  return (
    <section className="relative py-8 lg:py-10 bg-[#F8F7F4] flex flex-col justify-center overflow-hidden">
      {/* Gradient fade at top */}
      <div className="absolute top-0 left-0 right-0 h-20 bg-gradient-to-b from-neutral-900/5 to-transparent pointer-events-none" />
      ...
      <div className="max-w-[800px] mx-auto px-6 w-full">
        ...
        <div className="space-y-3">
          {faqs.map((faq, i) => (
            <FadeUp key={i} delay={i * 0.08}>
              <div className="rounded-2xl border border-neutral-900/10 overflow-hidden hover:border-tarsier/40 transition-colors">
        ...
        <FadeUp delay={0.3}>
          <div className="mt-14 text-center">
            <p className="font-display text-[28px] lg:text-[42px] font-semibold text-text-primary leading-tight">
