  ...
  <div className="min-h-screen bg-bg-warm">
    ...
    <div className="pt-[72px]">
      <div className="max-w-[1280px] mx-auto px-6 lg:px-12 py-20">
        ...
        <h1 className="font-display text-[40px] sm:text-[56px] lg:text-[72px] font-bold text-text-primary leading-tight mb-6">
          Every system,<br />built for you.
        </h1>
        <p className="font-body text-[17px] text-text-secondary max-w-[560px] leading-relaxed mb-10 lg:mb-16">
